          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title"> pb_services</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <label for=" pb_services_name">name</label>
                    <input type="text" class="form-control" id=" pb_services_name" placeholder="name...">
                  </div>
                 
                 
                  <div class="form-group">
                    <label for=" pb_services_name">is core</label>
                    <input type="text" class="form-control" id=" pb_services_name" placeholder="name...">
                  </div>
