          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title"> pb_tasks</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <label for=" pb_tasks_name">name</label>
                    <input type="text" class="form-control" id=" pb_tasks_name" placeholder="user id...">
                  </div>
                 
                  <div class="form-group">
                    <label for=" pb_tasks_description">description</label>
                    <input type="text" class="form-control" id=" pb_tasks_description" placeholder="description ...">
                  </div>
