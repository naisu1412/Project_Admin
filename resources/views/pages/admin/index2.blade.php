                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="{{ asset("/admin-lte/dist/img/user1-128x128.jpg")}}" alt="message user image"><!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="{{ asset("/admin-lte/dist/img/user3-128x128.jpg")}}" alt="message user image"><!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
